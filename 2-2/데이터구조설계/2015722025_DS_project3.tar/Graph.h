...
public:
	...
	void setSize(int size) { m_vSize = size; };
	...
	void sortingpath(int *path,int size);

	void Insertsort(int e, int* path, int i);

	Edge * FindEdge(int start, int end);

	void Quicksort(int* path, int left, int rigt);
