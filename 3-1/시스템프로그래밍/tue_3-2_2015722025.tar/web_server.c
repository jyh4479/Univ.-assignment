...
//------------------------------------------------------------------//
//Title : System Programing Assignment #3-2 (Web_server)            //
//Description : The 3-2 task aims to understand the basic behavior  //
//              of servers and clients based on the html file,      //
//              and to understand the basic structure of            //
//              the Http server's request message and response      //
//              message. Additionally, you can find out how images, //
//              text, and executables can be sent to clients.       //
//////////////////////////////////////////////////////////////////////
#define _GNU_SOURCE
#include<stdio.h>
#include<stdlib.h>
